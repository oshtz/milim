...
User and assistant message bodies render Markdown in the transcript. Message actions, edit/resend, search, model context, and thread export keep using the raw stored source.
